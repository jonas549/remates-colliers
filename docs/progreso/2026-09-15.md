...
> Registro de la jornada del 15/09 (movido desde `docs/PROGRESO.md` el 16/09). Estado vivo: `docs/BACKLOG.md`.
> Las decisiones y pasos de esta página ya se ejecutaron; se conserva como historia.
