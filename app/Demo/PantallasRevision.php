        ...
        return [
            ...
            [
                ...
                'pantallas' => [
                    ...
                    ['nombre' => 'Reportes', 'ruta' => self::como('admin', '/admin/reportes'), 'estado' => 'terminada', 'nota' => 'DATOS DE EJEMPLO: se conectan en el Bloque O. CSV/XLSX/PDF aún sin funcionar.'],
                    ['nombre' => 'Ficha de remate (sin diseño)', 'ruta' => self::como('admin', '/admin/subastas/2'), 'estado' => 'terminada', 'nota' => 'Bloque I: datos, lotes, documentos, publicar, cancelar y crear remate nuevo.'],
                    ['nombre' => 'Panel del martillero (sin diseño)', 'ruta' => self::como('admin', '/admin/subastas/1/en-vivo'), 'estado' => 'terminada', 'nota' => 'Bloque I: precio, identidades, mensaje a la sala y cierre anticipado.'],
                    ['nombre' => 'Configuración (sin diseño)', 'ruta' => self::como('admin', '/admin/configuracion'), 'estado' => 'terminada', 'nota' => 'Bloque V: valores del negocio, SMTP con prueba, UF y sistema.'],
                ],
            ],
        ];
    }
