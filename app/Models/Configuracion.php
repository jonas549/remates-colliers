...
class Configuracion extends Model
{
    ...
    public const DEFECTOS = [
        ...
        'cierre_aviso_espera_segundos' => ['valor' => '5', 'tipo' => 'entero', 'grupo' => 'pujas', 'etiqueta' => 'Aviso del cierre: espera aleatoria (segundos)', 'min' => 0, 'max' => 60, 'descripcion' => 'Al cerrar un lote, cada espectador espera un tiempo al azar dentro de este rango antes de avisarle al servidor, para que el resultado se publique en segundos sin que todos pregunten a la vez. En 0 avisan todos de inmediato.'],
        'cierre_aviso_porcentaje' => ['valor' => '100', 'tipo' => 'entero', 'grupo' => 'pujas', 'etiqueta' => 'Aviso del cierre: espectadores que avisan (%)', 'min' => 0, 'max' => 100, 'descripcion' => 'Porcentaje de espectadores que avisan del cierre. Bájalo si la carga se descontrola; en 0 nadie avisa y el resultado lo publica el cron (hasta 1 minuto).'],
        // Remates
