...
// Solo para la comparación visual 1:1 en local (?demo=1): la puja se registra solo en pantalla.
// La sala real es sala.js (Bloque K), con los mismos getters que usa la vista.
export default ({ base, paso, actual, deltaCierre, historial, postor }) => ({
    ...
    get totalPujas() { return this.historialBruto.length; },
    get etiquetaContador() { return 'CIERRA EN'; },
