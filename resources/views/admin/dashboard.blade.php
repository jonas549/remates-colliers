<x-layouts.admin seccion="dashboard" titulo="Resumen general">
    <div class="admin-encabezado">
        ...
        <div class="admin-fecha">Lunes 31 de agosto de 2026 · UF $39.412,73</div>
    ...
    <div class="admin-dashboard">
                    ...
                    <tbody>
                        @foreach ($datos['subastas'] as $s)
                            <tr>
                                ...
                                <td>{{ $s['postores'] }}</td>
                                <td>{{ $s['cierre'] }}</td>
                                <td><a href="{{ route('admin.subastas') }}">Ver</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="admin-seccion">
            ...
            @foreach ($datos['pendientes'] as [$nombre, $detalle, $estado, $tono])
        ...
        <div class="admin-seccion">
            ...
            @foreach ($datos['actividad'] as [$texto, $hora, $color])
